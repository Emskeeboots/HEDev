...
// CONSTANTS -------------------------------------------------------------------
const string LANGUAGE_KNOWN         = "Language_"; // followed by integer, signifies whether PC knows language. Set on Skin.
const string LANGUAGE_SPOKEN_ID     = "hls_MyLanguage";
const string LANGUAGE_SPOKEN_NAME   = "hls_MyLanguageName";
const string LANGUAGE_TRADE_NEED    = "Language_Trade_Placeholder"; // PC deserves a trade language
