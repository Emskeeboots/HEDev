...
////////// added by Tom_Banjo on 02/02/2010 //////////
    if( GetWeaponRanged(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND))==FALSE)
    {
        if (GetDistanceBetween(GetAttemptedAttackTarget(),OBJECT_SELF)>6.0)
        {
