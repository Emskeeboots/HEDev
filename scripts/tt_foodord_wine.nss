void main()
{
    int nActive = GetLocalInt (OBJECT_SELF,"order_wine");
...
if (nActive == 0)
{
    ...
    if (GetGold(oPC) >= 80)
        ...
        CreateObject(OBJECT_TYPE_PLACEABLE,sFoodSpawn1,lTarget1,TRUE);
        CreateObject(OBJECT_TYPE_PLACEABLE,sFoodSpawn1,lTarget2,TRUE);
    ...
    SetLocalInt(OBJECT_SELF,"order_wine", 1);
    DelayCommand(2400.0, SetLocalInt(OBJECT_SELF, "order_wine", 0));
