...
void doTrap(object oTrap)
{
    ...
    if(nDamTmp>0)
    {
        ...
        AssignCommand(oTrap,ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectDamage(nDamTmp, DAMAGE_TYPE_PIERCING), oTriggerer));
    }
...
void main()
{
    ...
    if(GetLocalInt(OBJECT_SELF,"TRP_PLCBL_SHOW")==0)
    {
        ...
        oTrap = CreateObject(OBJECT_TYPE_PLACEABLE,"swinginspikepcbl",lPlcbl);
