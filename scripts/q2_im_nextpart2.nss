...
/*
    ...
    on the tailor to the next available color
...
void main()
{
    ...
    if(GetIsObjectValid(oItem) == TRUE)
    {
        ...
        {
            oNew = Q_IPGetModifiedShield(oItem, ITEM_APPR_TYPE_WEAPON_COLOR, nPart, X2_IP_WEAPONTYPE_NEXT, TRUE);
            CISetCurrentModItem(oPC,oNew);
